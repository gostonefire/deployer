...
cd /home/petste/Develop/"$REPO_NAME" >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
...
git fetch --tags --prune >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
if [ $EXIT_CODE -ne 0 ]; then
...
git checkout -f "$VERSION_TAG" >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
if [ $EXIT_CODE -ne 0 ]; then
...
cargo clean >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
if [ $EXIT_CODE -ne 0 ]; then
...
cargo build --release >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
if [ $EXIT_CODE -ne 0 ]; then
...
./scripts/deploy.sh >> /home/petste/MyDeployer/logs/scripts.log 2>&1
EXIT_CODE=$?
if [ $EXIT_CODE -ne 0 ]; then
